...
const UserVocabGroupPage: React.FC = () => {
  ...
  const compare = useAiInsight('custom-vocab:compare');
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900 animate-page-enter">
      ...
      {/* Mobile FABs — portalled to body to escape animation stacking context */}
      {!loading && !flashMode && ReactDOM.createPortal(
      ...
      {confirmDeleteWord && ReactDOM.createPortal(
