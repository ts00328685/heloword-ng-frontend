...
const OnboardingModal: React.FC<OnboardingModalProps> = ({ steps, onDone, onSkip }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center bg-black/50 backdrop-blur-sm px-4 pb-6 sm:pb-0">
      <div className="bg-white dark:bg-gray-900 rounded-3xl w-full max-w-sm shadow-2xl overflow-hidden animate-fade-in">
