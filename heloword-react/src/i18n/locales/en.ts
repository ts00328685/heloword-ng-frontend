const en = {
  ...
  quizMode: {
    ...
    subtitle: '{{count}} words in this group',
    spelling: 'Spelling',
    spellingDesc: 'Read the meaning, type the word. The slowest mode, and the one that sticks best.',
    matching: 'Match Pairs',
    matchingDesc: 'Link words to meanings across two columns — 5 to 10 words per round.',
    blast: 'Word Blast',
    blastDesc: 'A meaning appears, tap its word in the grid. Chain them for a combo streak.',
    requires: 'Needs at least {{count}} words',
    start: 'Start',
    setProgress: 'Round {{current}} / {{total}}',
    remaining: '{{count}} left',
    matchHint: 'Tap a word on the left, then its meaning on the right',
    blastHint: 'Tap the matching word',
    wrongReset: 'Wrong pair — start over',
    setClear: 'Round clear!',
    combo: '{{count}} combo',
    bestCombo: 'best {{count}}',
    pronounceOnTap: 'Pronounce on tap',
    drop: 'Word Drop',
  ...
  board: {
    ...
    endedNotice: 'This session has ended or hasn’t started yet. You can read the messages but can no longer post.',
    endedAdminNotice: 'This session has ended or hasn’t started yet — your message will be posted as an official announcement.',
